...
class Review(TypedDict):
    ...
    summary:Annotated[Literal["pos","neg"],"A brief summary of thr review"]
    sentiment:Annotated[int,"Return sentiment of the review either negative, positive or neutral"]
